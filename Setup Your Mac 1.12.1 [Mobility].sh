...
departmentListRaw="GroundControl Project,PowerIT Kiosk"

# A sorted, unique, JSON-compatible list of departments
departmentList=$( echo "${departmentListRaw}" | tr ',' '\n' | sort -f | uniq | sed -e 's/^/\"/' -e 's/$/\",/' -e '$ s/.$//' )

# Branding overrides
brandingBanner="https://img.freepik.com/free-photo/blue-watercolor-gradient-background_95678-187.jpg"
...
brandingIconDark="https://www.highmarkhealth.org/annualreport2022/images/HHlogo-footer.svg"
...
supportTeamPhone="+1 (833) 690-4357 (AHN)"
...
welcomeTitle="Welcome to your ${modelName}"

welcomeMessage="Please enter the **required** information, select your preferred **Configuration**, and click **Continue** to set up your new Mac. \n\nThe **Wait** button appear and you‘ll be able to review the results before being prompted to logout and enable FileVault. \n\nIf you need assistance, please contact the ${supportTeamName}: ${supportTeamPhone}. \n\n---"
...
if [[ "${brandingBannerDisplayText}" == "true" ]]; then welcomeBannerText="Welcome to your new ${modelName}";
...
if [ "$promptForAssetTag" == "true" ]; then
    assetTagJSON='{   "title" : "Asset Tag",
        ...
        "regex" : "^(ahn|AHN|osx|OSX)?[0-9]{6,}$",
        "regexerror" : "For AHN users, please enter the six digits from the Asset Tag starting with AHN. \n\nFor Highmark users, please start with osx. (i.e. AHN123456, osx987654)"
    },'
fi
        ...
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video`, `messageOnly` or `false`)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Enabling Security Requirements",
                        "icon": "19c4b3333bea4b0eccb90ee3c7e1c28a06838303c6fa9b64ddeeb47e231cc685",
                        "progresstext": "Installing Microsoft Defender, Flexera FNMS Agent, Forcepoint DLP, and VNC Sever.",
                        "trigger_list": [
                            {
                                "trigger": "recon",
                                "validation": "Recon"
                            ...
                            {
                                "trigger": "vncserver",
                                "validation": "/Applications/RealVNC/VNC Server.app/Contents/Info.plist"
                            },
                            {
                    ...
                    {
                        "listitem": "GroundControl Launchpad",
                        "icon": "a89839e973d7d51e40ed919c4087edcb5185a825d8edd8da587ac42fbee20e12",
                        "progresstext": "",
                        "trigger_list": [
                            {
                                "trigger": "groundControl",
                                "validation": "/Applications/GroundControl Launchpad.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Microsoft Edge",
                        "icon": "e0f1c680c10301bd07c8dc9119f5caed7fff1146869902ef9c0cda99854a4209",
                        "progresstext": "Microsoft’s modern internet browser.",
                        "trigger_list": [
                            {
                                "trigger": "edge",
                    ...
                    },
                    {
                        ...
                        "icon": "6fcb009cb81e45cea0cbfaea1fac7c7f096ebd539a2217dd09faafb54b2c5e76",
                        "progresstext": "Chat, file sharing, meetings, telephony, video streaming, and more integrated into Microsoft 365.",
                        "trigger_list": [
                            {
                                "trigger": "teams",
