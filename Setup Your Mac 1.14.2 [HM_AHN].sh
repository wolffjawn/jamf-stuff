...
departmentListRaw="enGen, choose **-** if dept not listed,-"
...
brandingIconLight="https://brand.highmarkhealth.org/content/dam/digital-marketing/brand/child-page-highmark-health/highmark-health.png"
brandingIconDark="https://www.highmarkhealth.org/hmk/images/footer/HHlogo-footer.svg"

# IT Support Variables - Use these if the default text is fine but you want your org's info inserted instead
supportTeamName="Client Service Desk"
supportTeamPhone="+1 (800) 561-2802 (Highmark) or +1 (833) 690-4357 (AHN)"
supportTeamErrorKB=", and request an **urgent ticket to Mac Desktop Services for Device Setup Assistance**"
...
if [[ "${requiredMinimumBuild}" == "disabled" ]]; then
    ...
    if [[ "${osMajorVersion}" -ge 12 ]] ; then
        ...
        # When the current `osBuild` is older than `requiredMinimumBuild`; exit with error
            ...
            osascript -e 'display dialog "Your Mac does not meet the minimum Operating System requirements.\r\rPlease click Upgrade macOS and on the following screen, Upgrade to upgrade your computer.\r\r" with title "Setup Your Mac: Detected Outdated Operating System" buttons {"Upgrade macOS"} with icon caution'
    ...
    # The Mac is running an operating system older than macOS 12 Monterey; exit with error
        ...
        osascript -e 'display dialog "Your Mac does not meet the minimum Operating System requirements.\r\rPlease click Upgrade macOS and on the following screen, Upgrade to upgrade your computer.\r\r" with title "Setup Your Mac: Detected Outdated Operating System" buttons {"Open Software Update"} with icon caution'
        updateScriptLog "PRE-FLIGHT CHECK: Executing /usr/bin/open '${outdatedOsAction}' …"
        su - "${loggedInUser}" -c "/usr/bin/open \"${outdatedOsAction}\""
        exit 1
...
welcomeTitle="Happy $( date +'%A' )!  \nWelcome to your new ${modelName}"

welcomeMessage="Please enter the **required** information for your ${modelName}, select your preferred **Organization** then click **Continue** to start applying settings to your new Mac. \n\nOnce completed, the **Wait** button will be enabled and you‘ll be able to review the results before being prompted to logout and enable FileVault."
...
if [[ "${brandingBannerDisplayText}" == "true" ]]; then
    welcomeBannerText="Happy $( date +'%A' )!  \nWelcome to your new ${modelName}"
else
    welcomeBannerText=" "
fi
...
if [ "$promptForAssetTag" == "true" ]; then
    assetTagJSON='{   "title" : "Asset Tag",
        "required" : true,
        "prompt" : "Please enter the Asset Tag number",
        "regex" : "^(ahn|AHN|osx|vm|VM|OSX)?[0-9]{6,}$",
        "regexerror" : "Please enter the (at least) six digits from the Asset Tag, optionally starting with AHN or osx, depending on your organization. (i.e. AHN123456, osx987654)"
    },'
fi
...
title="Setting up your ${modelName}"
message="Please wait while the following apps are installed …"

if [[ "${brandingBannerDisplayText}" == "true" ]] ; then
    bannerText="Setting up your ${modelName}";
else
    bannerText=" "
fi
        ...
        "${configurationThreeName}" )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Final Configuration",
                        "subtitle": "Configures remaining corporate settings",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_4723e3e341a7e11e6881e418cf91b157fcc081bdb8948697750e5da3562df728",
                        "progresstext": "Finalizing Configuration …",
                        "trigger_list": [
                            {
        ...
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video`, `messageOnly` or `false`)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Preparing Device for Configuration",
                        "subtitle": "Baseline settings",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_19c4b3333bea4b0eccb90ee3c7e1c28a06838303c6fa9b64ddeeb47e231cc685",
                        "progresstext": "Preparing device for custom configurations.",
                        "trigger_list": [
                            {
                                "trigger": "sethostname",
                                "validation": "None"
                    ...
                    {
                        "listitem": "macOS Security Compliance",
                        "subtitle": "DISA-STIG",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_005955b44d50ea74cfe1abdbdf571cd86813b6e95e10484d99441ae0bb6f659e",
                        "progresstext": "Enforcing DISA-STIG Compliance Guidelines.",
                        "trigger_list": [
                            {
                                "trigger": "disaCheck",
                                "validation": "None"
                    ...
                    {
                        "listitem": "Forcepoint DLP Endpoint",
                        "subtitle": "Secure sensitive data on macOS devices on or off the network",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_98c5d15c45eef264f1a54ef3cb3682848ed20f9e7ac6846a25b08fd6cf5233d2",
                        "progresstext": "Forcepoint Data Loss Prevention (DLP) enables businesses to discover, classify, monitor, and protect data intuitively.",
                        "trigger_list": [
                            {
                                "trigger": "forcepoint",
                                "validation": "/Applications/Forcepoint DLP Endpoint.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Flexera",
                        "subtitle": "Industry leading management tools",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_b3b30f3f2f1300ee2e154078d994b22fd1f5890b025c746f8f4b31c08500d772",
                        "progresstext": "Operational monitoring, management, and governance.",
                        "trigger_list": [
                            {
                                "trigger": "flexera",
                                "validation": "None"
                    ...
                    },
                    {
                        ...
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_fcc9b1590c85f8ba39f9a2bfd672b9046869cb0a256dcd0751006bbb43414328",
                        "progresstext": "Cloud-native insight platform for analytics-driven cyber security risk management.",
                        "trigger_list": [
                            {
                                "trigger": "rapid7",
                                "validation": "None"
                            ...
                            {
                                "trigger": "rapid7Configure",
                                "validation": "None"
                            }
                        ]
                    },
                    {
                        "listitem": "Microsoft Defender",
                        "subtitle": "Enterprise-grade security platform",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_c575916e7c08c0d3850298afc0927db911c46ad1554a4311dfc81c6b6a2b37a1",
                        "progresstext": "Microsoft Defender helps defend against advanced persistent threats.",
                        "trigger_list": [
                            {
                                "trigger": "defender",
                                "validation": "/Applications/Microsoft Defender.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "VNC Server",
                        "subtitle": "Mac IT Remote Access",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_95f966e2b0290387b391b39dafbf5b31431d074c819eae5e7a64a816a6310792",
                        "progresstext": "Mac Desktop Services uses this tool to assist remotely.",
                        "trigger_list": [
                            {
                                "trigger": "vncserver",
                                "validation": "None"
                            ...
                            {
                                "trigger": "vncserverpolicy",
                                "validation": "None"
                            }
                        ]
                    },
                    {
                        "listitem": "VMware Horizon Client",
                        "subtitle": "Virutal Windows Machine",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_33d7ec93777badeb86e65920d3b0864eb67d2c032842c025e4be45ca875e59b0",
                        "progresstext": "Because sometimes you just need a PC in this environment.",
                        "trigger_list": [
                            {
                                "trigger": "vmware",
                                "validation": "/Applications/VMware Horizon Client.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        ...
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_d1b4c6d3f7f6f73d6582ba074d3f16fa23c3959c2e1813c789bb00757a21ff12",
                        "progresstext": "Microsoft Intune helps organizations manage access to corporate apps, data, and resources.",
                        "trigger_list": [
                            {
                                "trigger": "intune",
                    ...
                    },
                    {
                        ...
                        "subtitle": "Microsoft’s Modern Web Browser",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_e60f4caa7ae6ba6172aea441bb10de76627567566e9745b5531dd68508eb9b28",
                        "progresstext": "Edge is a secure and user-friendly web browser from Microsoft.",
                        "trigger_list": [
                            {
                                "trigger": "edge",
                    ...
                    },
                    {
                        ...
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_acbf39d8904ad1a772cf71c45d93e373626d379a24f8b1283b88134880acb8ef",
                        "progresstext": "Use Palo Alto GlobalProtect to establish a Virtual Private Network (VPN) connection to Highmark.",
                        "trigger_list": [
                            {
                                "trigger": "globalProtect",
                                "validation": "/Applications/GlobalProtect.app/Contents/Info.plist"
                    ...
                    },
                    {
                        ...
                        "subtitle": "The listing of your Mac’s apps and settings",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_ff2147a6c09f5ef73d1c4406d00346811a9c64c0b6b7f36eb52fcb44943d26f9",
                        "progresstext": "Your Mac’s apps and settings — its inventory — is sent automatically to the Jamf Pro server daily.",
                        "trigger_list": [
                            {
                                "trigger": "symPLIST",
                                "validation": "None"
...
function finalise(){
    ...
    if [[ "${jamfProPolicyTriggerFailure}" == "failed" ]]; then
        ...
        if [[ "${brandingBannerDisplayText}" == "true" ]] ; then dialogUpdateSetupYourMac "title: Your ${modelName} is ready!"; fi
